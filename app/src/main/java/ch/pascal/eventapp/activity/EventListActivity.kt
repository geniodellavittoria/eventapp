package ch.pascal.eventapp.activity
...
import ch.pascal.eventapp.R

import ch.pascal.eventapp.dummy.DummyContent
                ...
                if (twoPane) {
                    val fragment = EventDetailFragment().apply {
                        arguments = Bundle().apply {
                            putString(EventDetailFragment.ARG_ITEM_ID, item.id)
                        }
                    }
